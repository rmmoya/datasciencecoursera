...
Data from https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip is grouped by the activity type and the subject measurement. For all the features described below, the mean function is applied to summarize each of them.
...
The set of variables that were estimated from these signals in the tidied data set are: 
